...
{
    /// <summary>
    /// Maps routes to the HTTP connection dispatcher.
    /// </summary>
    public class ConnectionsRouteBuilder
    {
        ...
        /// <summary>
        /// Maps incoming requests with the specified path to the dispatcher.
        /// </summary>
        ...
        /// </summary>
        /// <param name="path">The request path.</param>
        /// <param name="options">Options used to configure the dispatcher.</param>
        /// <param name="configure">A callback to configure the connection.</param>
        ...
        /// <summary>
        /// Maps incoming requests with the specified path to a connection handler.
        /// </summary>
